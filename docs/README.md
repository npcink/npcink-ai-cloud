...
- [Media Fingerprints, Visual Evidence, and Article ALT Development Standard](media-alt-and-visual-evidence-development-standard-v1.md) — development lessons and staged delivery plan for exact-fingerprint freshness, derivative evidence, and recommendation reuse
