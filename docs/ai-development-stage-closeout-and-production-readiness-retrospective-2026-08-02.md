...
- [Repository Hygiene and Documentation Lifecycle Standard v1](repository-hygiene-and-documentation-lifecycle-standard-v1.md)；
...
本文在 2026-08-03 纳入仓库时重新确认：

- `origin/master=f62b3921bd51c966da87084a49d30954fd165ce9`；
- M4 已从 clean current master 接受 PR #508，`acceptance_state=accepted`、
  `source_branch=master`、`source_dirty=false`；
- JavaScript 高危依赖告警已由 #508 清零；
- `origin/production=74e074245345b1c9476e5671a762ceefee90e662`，production
  仍未改变；
- production queue Issue #406 仍为 open，尚未获得本文所列生产验收证据。
...
- [x] 已完成：源代码、CI、M4 candidate、accepted、production 与人类验收的
      证据层级已经制度化。
- [x] 已完成：收尾阶段将 PostCSS 与 brace-expansion 的三条高危依赖告警在
      #508 中统一修复，并完成 clean-master M4 accepted。
