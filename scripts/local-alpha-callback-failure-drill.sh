...
EVIDENCE_DIR="${MAGICK_AI_CALLBACK_FAILURE_DRILL_EVIDENCE_DIR:-${ROOT_DIR}/.tmp/local-alpha-callback-failure-drill}"
SUFFIX="${MAGICK_AI_CALLBACK_FAILURE_DRILL_SUFFIX:-$(date -u '+%Y%m%d%H%M%S')}"
