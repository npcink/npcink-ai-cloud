...
const ADMIN_ROUTE_RULES: readonly AdminRouteRule[] = [
  ...
  {
    methods: ['GET'],
    pattern: /^(?:overview|plugin-observability|media-observability|vector-observability|agent-feedback|editor-assist-quality|runtime-telemetry(?:\/runs)?|agent-workflow-metadata)$/,
    namespace: 'admin',
