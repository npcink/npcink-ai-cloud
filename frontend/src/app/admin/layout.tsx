    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          collapsedLabel: 'RD',
          activePrefixes: ['/admin/troubleshooting'],
        },
        {
          href: '/admin/media-observability',
          labelKey: 'admin.media_obs.title',
          fallback: 'Media Processing Observability',
          collapsedLabel: 'MO',
          secondary: true,
        },
        {
          href: '/admin/vector-observability',
          labelKey: 'admin.vector_obs.title',
          fallback: 'Vector Observability',
          collapsedLabel: 'VO',
          secondary: true,
        },
      ],
