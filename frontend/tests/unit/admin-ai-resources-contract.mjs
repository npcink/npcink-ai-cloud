...
assert.match(externalServicesSource, /AdminWorkbenchDialog[\s\S]*readOnly value=\{editingOption\.baseUrl\}/);
assert.match(externalServicesSource, /AdminCredentialField/);
assert.match(externalServicesSource, /AdminSettingsDisclosure/);
