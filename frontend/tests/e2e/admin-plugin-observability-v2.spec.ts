...
test('Chinese labels explain known events and retain original identifiers', async ({page}) => {
  ...
  await expect(page.getByRole('heading',{name:'插件排查',exact:true})).toBeVisible();
