...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_provider_budget_counters_provider_id", "provider_budget_counters", ["provider_id"]
    )
    op.create_index(
        "ix_provider_budget_counters_account_class", "provider_budget_counters", ["account_class"]
    )
    op.create_index(
        "ix_provider_budget_counters_period_kind", "provider_budget_counters", ["period_kind"]
    )
    op.create_index(
        "ix_provider_budget_counters_period_start_at",
        "provider_budget_counters",
        ["period_start_at"],
    )
    op.create_index(
        "ix_provider_budget_counters_period_end_at", "provider_budget_counters", ["period_end_at"]
    )
    ...
    op.create_index(
        "ix_provider_budget_claims_dispatch_key", "provider_budget_claims", ["dispatch_key"]
    )
    ...
    op.create_index(
        "ix_provider_budget_claims_account_id", "provider_budget_claims", ["account_id"]
    )
    op.create_index(
        "ix_provider_budget_claims_provider_id", "provider_budget_claims", ["provider_id"]
    )
    op.create_index(
        "ix_provider_budget_claims_account_class", "provider_budget_claims", ["account_class"]
    )
    op.create_index(
        "ix_provider_budget_claims_period_kind", "provider_budget_claims", ["period_kind"]
    )
    op.create_index("ix_provider_budget_claims_status", "provider_budget_claims", ["status"])
    op.create_index(
        "ix_provider_budget_claims_created_at", "provider_budget_claims", ["created_at"]
    )
    op.create_index(
        "ix_provider_budget_claims_reconciled_at", "provider_budget_claims", ["reconciled_at"]
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        "ix_provider_budget_counters_period_end_at", table_name="provider_budget_counters"
    )
    op.drop_index(
        "ix_provider_budget_counters_period_start_at", table_name="provider_budget_counters"
    )
    op.drop_index("ix_provider_budget_counters_period_kind", table_name="provider_budget_counters")
    op.drop_index(
        "ix_provider_budget_counters_account_class", table_name="provider_budget_counters"
    )
